...
public class MarketBook {
    ...
    private Integer homeTeamScore = -1; //Default value
    private Integer guestTeamScore = -1; //Default value
    ...
    public void setHomeTeamScore() {
        ScoresRetriever scoresRetriever = new ScoresRetriever();
        this.homeTeamScore = scoresRetriever.getScoresForMarketID(this.getMarketId()).getHomeTeam();
    }
    ...
    public void setGuestTeamScore() {
        ScoresRetriever scoresRetriever = new ScoresRetriever();
        this.guestTeamScore = scoresRetriever.getScoresForMarketID(this.getMarketId()).getAwayTeam();;
    }
